namespace NetWolf
{
    public static class BuiltinSymbolM
    {
        ...
        {
            return en.Execute("Manipulate[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
        ...
        {
            return en.Execute("Manipulator[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("MapAt[" + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + "]", name);
        }
        ...
        {
            return en.Execute("MAProcess[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
        ...
        {
            return en.Execute("MapThread[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
        ...
        {
            return en.Execute("MathematicalFunctionData[" + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + "]", name);
        }
        ...
        {
            return en.Execute("Matrices[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("Matrices[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
        ...
        {
            return en.Execute("MaximalBy[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
        ...
        {
            return en.Execute("MeanAround[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("MeanShift[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
        ...
        {
            return en.Execute("MenuView[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("MenuView[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
        ...
        {
            return en.Execute("MeshConnectivityGraph[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
        ...
        {
            return en.Execute("MeshRegion[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
        ...
        {
            return en.Execute("MessageDialog[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("MinimalBy[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
        ...
        {
            return en.Execute("MinimalStateSpaceModel[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("MoleculeMaximumCommonSubstructure[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("MonomialList[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("MonomialList[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
        ...
        {
            return en.Execute("MultiplicativeOrder[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
