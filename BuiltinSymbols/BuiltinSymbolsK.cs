namespace NetWolf
{
    public static class BuiltinSymbolK
    {
        ...
        {
            return en.Execute("KagiChart[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("KagiChart[" + arg0 + "]", name);
        }
        ...
        {
            return en.Execute("KarhunenLoeveDecomposition[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("KEdgeConnectedComponents[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
        ...
        {
            return en.Execute("Keys[" + arg0 + "]", name);
        }
        ...
        {
            return en.Execute("KeyTake[" + arg0 + "]", name);
        }
        ...
        {
            return en.Execute("KeyUnion[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("KirchhoffGraph[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("KochCurve[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("KochCurve[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
        ...
        {
            return en.Execute("KVertexConnectedComponents[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
