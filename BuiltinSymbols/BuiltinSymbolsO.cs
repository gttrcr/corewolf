namespace NetWolf
{
    public static class BuiltinSymbolO
    {
        ...
        {
            return en.Execute("ObservableDecomposition[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("Octahedron[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("OpenerView[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("OrdinalScale[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("Orthogonalize[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("OutputResponse[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("Overlay[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("Overlay[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
