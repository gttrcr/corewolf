namespace NetWolf
{
    public static class BuiltinSymbolH
    {
        ...
        {
            return en.Execute("HankelMatrix[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("Hexahedron[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("Histogram[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("Histogram[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
        ...
        {
            return en.Execute("Histogram3D[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("Histogram3D[" + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + "]", name);
        }
        ...
        {
            return en.Execute("Histogram3D[" + arg0 + "]", name);
        }
        ...
        {
            return en.Execute("HistogramTransformInterpolation[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
        ...
        {
            return en.Execute("HitMissTransform[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
