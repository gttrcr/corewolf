namespace NetWolf
{
    public static class BuiltinSymbolQ
    {
        ...
        ///</summary>
        public static Engine QHypergeometricPFQ(this Engine en, object arg0, object arg1, object arg2, object arg3, string? name = null)
        {
            return en.Execute("QHypergeometricPFQ[" + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + "]", name);
        }
