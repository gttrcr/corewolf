namespace NetWolf
{
    public static class BuiltinSymbolT
    {
        ...
        {
            return en.Execute("Table[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
        ...
        {
            return en.Execute("Table[" + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + "]", name);
        }
        ...
        {
            return en.Execute("TabView[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("TabView[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
        ...
        {
            return en.Execute("TautologyQ[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("TemporalData[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
        ...
        {
            return en.Execute("TemporalData[" + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + "]", name);
        }
        ...
        {
            return en.Execute("TensorContract[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
        ...
        {
            return en.Execute("TernaryListPlot[" + arg0 + "]", name);
        }
        ...
        {
            return en.Execute("Tetrahedron[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("TextGrid[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("ThermodynamicData[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
        ...
        {
            return en.Execute("TimeSeriesMapThread[" + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + "]", name);
        }
        ...
        {
            return en.Execute("ToeplitzMatrix[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("Toggler[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("ToNumberField[" + arg0 + "]", name);
        }
        ...
        {
            return en.Execute("TourVideo[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
        ...
        {
            return en.Execute("TradingChart[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("Translate[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
        ...
        {
            return en.Execute("TravelDirections[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("TreeGraph[" + arg0 + "]", name);
        }
        ...
        {
            return en.Execute("TriangleWave[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("TriangularDistribution[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("Trigger[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("Trigger[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
        ...
        {
            return en.Execute("TruncatedDistribution[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
        ...
        {
            return en.Execute("Tuples[" + arg0 + "]", name);
        }
