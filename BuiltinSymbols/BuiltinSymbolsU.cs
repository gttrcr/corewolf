namespace NetWolf
{
    public static class BuiltinSymbolU
    {
        ...
        {
            return en.Execute("UniformDistribution[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("UniformPolyhedron[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("UniformPolyhedron[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
        ...
        {
            return en.Execute("UniformSumDistribution[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("UnixTime[" + arg0 + ", " + arg1 + "]", name);
        }
        ...
        {
            return en.Execute("Unprotect[" + arg0 + "]", name);
        }
        ...
        {
            return en.Execute("URLDownloadSubmit[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
        ...
        {
            return en.Execute("URLQueryEncode[" + arg0 + "]", name);
        }
