namespace NetWolf
{
    public static class BuiltinSymbolJ
    {
        ...
        ///</summary>
        public static Engine JoinedCurve(this Engine en, object arg0, string? name = null)
        {
            return en.Execute("JoinedCurve[" + arg0 + "]", name);
        }
        ...
        ///</summary>
        public static Engine JoinAcross(this Engine en, object arg0, object arg1, object arg2, string? name = null)
        {
            return en.Execute("JoinAcross[" + arg0 + ", " + arg1 + ", " + arg2 + "]", name);
        }
